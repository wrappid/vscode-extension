...
export function activate(context: vscode.ExtensionContext) {
	context.subscriptions.push(boilerPlate,simplecompletions,provideCoreCompletion,keyCompletion,subKeyCompletion,subSubKeyCompletion,subSubSubKeyCompletion);
}
